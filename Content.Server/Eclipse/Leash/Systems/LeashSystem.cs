...
using Content.Server.Eclipse.Leash.Components;
using Content.Shared.Alert;
using Content.Shared.Eclipse.Leash;
using Content.Shared.Eclipse.Leash.Components;
...
namespace Content.Server.Eclipse.Leash.Systems;

public sealed class LeashSystem : EntitySystem
{
    private static readonly SpriteSpecifier.Rsi LeashVisualSprite =
        new(new ResPath("/Textures/Eclipse/Objects/Fun/ERP/leash_line.rsi"), "line");
