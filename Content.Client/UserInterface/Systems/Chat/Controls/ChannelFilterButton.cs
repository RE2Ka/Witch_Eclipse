...
{
    private static readonly Color ColorNormal = Color.FromHex("#E6A11ACC");
    private static readonly Color ColorHovered = Color.FromHex("#FFBE3D");
    private static readonly Color ColorPressed = Color.FromHex("#A85E12");
