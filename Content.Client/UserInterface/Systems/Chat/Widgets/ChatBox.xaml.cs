...
{
    private static readonly Color EclipseChatBackground = Color.FromHex("#070300F6");
    private static readonly Color EclipseChatSurface = Color.FromHex("#100500EA");
    private static readonly Color EclipseChatInput = Color.FromHex("#1A0800F6");
    private static readonly Color EclipseChatButton = Color.FromHex("#3A1700F4");
    private static readonly Color EclipseChatBorder = Color.FromHex("#E6A11AAA");
    private static readonly Color EclipseChatAccent = Color.FromHex("#E6A11ACC");
    ...
    public void ApplyEclipseChatStyle()
    {
        ...
        Contents.StyleBoxOverride = Rounded(EclipseChatSurface, Color.FromHex("#E6A11A44"), 4f);
        ...
        ChatInput.ChannelSelector.StyleBoxOverride = Rounded(EclipseChatButton, Color.FromHex("#E6A11A66"), 4f);
        ...
        ChatInput.FilterButton.StyleBoxOverride = Rounded(EclipseChatButton, Color.FromHex("#E6A11A88"), 4f);
    }
