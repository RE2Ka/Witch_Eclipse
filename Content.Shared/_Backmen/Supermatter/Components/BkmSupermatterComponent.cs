...
public sealed partial class BkmSupermatterComponent : Component
{
    ...
    /// <summary>
    /// Minimum passive radiation emitted while the crystal is processing atmosphere.
    /// </summary>
    [DataField]
    public float MinimumRadiationIntensity = 1f;

    /// <summary>
    /// Converts accumulated supermatter power into radiation source intensity.
    /// </summary>
    [DataField]
    public float RadiationPowerModifier = 0.003f;
