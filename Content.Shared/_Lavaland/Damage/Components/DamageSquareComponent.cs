...
public sealed partial class DamageSquareComponent : Component
{
    ...
    /// <summary>
    /// How much of the tile center counts as a hit. Keeping this below 1 gives
    /// players a fair edge escape and avoids hits from broad collision bounds.
    /// </summary>
    [DataField, AutoNetworkedField]
    public float HitboxScale = 0.78f;
}
