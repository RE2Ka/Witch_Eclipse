...
using LavalandGunUpgradeComponent = Content.Shared._Lavaland.Weapons.Ranged.Upgrades.Components.GunUpgradeComponent;
...
public abstract partial class SharedGunUpgradeSystem : EntitySystem
{
    ...
    public HashSet<Entity<LavalandGunUpgradeComponent>> GetCurrentUpgrades(Entity<UpgradeableWeaponComponent> ent, ItemSlotsComponent? itemSlots = null)
    {
