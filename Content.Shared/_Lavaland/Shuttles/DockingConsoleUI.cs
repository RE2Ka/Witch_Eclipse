...
[Serializable, NetSerializable]
public sealed class DockingConsoleState(
    FTLState ftlState,
    StartEndTime ftlTime,
    List<DockingDestination> destinations,
    List<DockingDestination> beacons) : BoundUserInterfaceState
{
    ...
    public List<DockingDestination> Beacons = beacons;
}
...
[Serializable, NetSerializable]
public sealed class DockingConsoleBeaconFTLMessage(int index) : BoundUserInterfaceMessage
{
    public int Index = index;
}
